...
3) AXIOS:
   Axios é um cliente HTTP promises based, ou seja, ele faz requisições HTTP para o servidor, para que não tenhamos que configurar toda essa comunicação entre cliente e servidor manualmente.
